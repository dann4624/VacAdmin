        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title text-capitalize">@lang('delete') @lang($singular)</h5>
                ...
                <div class="modal-footer">
                    <form method="post" action="{{route(Request::segment(1).'.destroy', [$singular => $entity['id']])}}" id="deleteForm" class="form-inline">
                        @method('delete')
                        @csrf
                        <button class="btn btn-danger text-capitalize" id="ajaxSubmit">@lang('delete')</button>
                    </form>
                </div>
            </div>
        </div>
